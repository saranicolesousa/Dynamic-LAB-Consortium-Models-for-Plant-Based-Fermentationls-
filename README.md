...
1. Curate and standardize GEMs of selected LAB strains.
2. Define representative chickpea and fava bean media in COBRApy.
3. Analyze potential metabolic interactions and cross-feeding using SMETANA.
4. Simulate microbial communities using MICOM to explore metabolic fluxes and off-flavor mitigation.
